...
public class A_Left extends CommandGroup
{
    ...
    {
    	if (gameData.charAt(0) == 'L' ) //TODO: COMMENT IN && gameData.charAt(1) != 'L')
    	{
    		//Left Side Switch
    		...
    		//TODO: COMMENT INaddSequential(new DriveForward(20));
...
//    	}
    	else 
    	{
    		...
    		addSequential(new DriveForward(140)); //TODO: comment in 148.875));
    	}
    }
}
